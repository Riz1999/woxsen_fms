...
const REACT_APP_NGROK_BACKEND_URI = process.env.REACT_APP_NGROK_BACKEND_URI
const config = {
  headers: {
...
const SignInSignUpPage = ({ onLoginSuccess }) => {
  ...
  const handleSignIn = async () => {
    try {
      const response = await axios.post(`${REACT_APP_NGROK_BACKEND_URI}/api/login`, {
        email,
        password,
      }, config);
  ...
  const handleSignUp = async () => {
    ...
    try {
      const response = await axios.post(`${REACT_APP_NGROK_BACKEND_URI}/api/signup`, {
        name,
        email,
        password,
      }, config);
  ...
  const handleOTPValidation = async () => {
    try {
      const response = await axios.post(
        `${REACT_APP_NGROK_BACKEND_URI}/api/otp/validate`,
        {
          email,
          otp,
        }, config
